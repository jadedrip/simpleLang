...
define dso_local i32 @si() #0 {
  ret i32 add nsw (i32 add nsw (i32 add nsw (i32 ptrtoint (i8* (i32, i64)* @createObject to i32), i32 ptrtoint (void (i8*, void (i8*)*)* @freeObject to i32)), i32 ptrtoint (i32 (i8*)* @referenceIncrease to i32)), i32 ptrtoint (i8* (i32, i64, i32)* @createArray to i32))
}
